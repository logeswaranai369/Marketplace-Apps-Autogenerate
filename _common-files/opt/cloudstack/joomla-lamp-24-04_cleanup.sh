...
echo
echo -e "${RED}Credential: joomla_admin_password (stored at /root/.joomla_admin_password)${NC}"
cat /root/.joomla_admin_password
echo
echo -e "${RED}Credential: joomla_db_password (stored at /root/.joomla_db_password)${NC}"
cat /root/.joomla_db_password
echo
