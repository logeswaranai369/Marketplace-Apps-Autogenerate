...
echo
echo -e "${RED}Credential: moodle_db_password (stored at /root/.moodle_db_password)${NC}"
cat /root/.moodle_db_password
echo
echo -e "${RED}Credential: moodle_admin_password (stored at /root/.moodle_admin_password)${NC}"
cat /root/.moodle_admin_password
echo
