...
echo
echo -e "${RED}Credential: zabbix_db_password (stored at /root/.zabbix_db_password)${NC}"
cat /root/.zabbix_db_password
echo
echo -e "${RED}Credential: zabbix_admin_password (stored at /root/.zabbix_admin_password)${NC}"
cat /root/.zabbix_admin_password
echo
