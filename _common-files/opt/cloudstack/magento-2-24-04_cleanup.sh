...
echo
echo -e "${RED}Credential: magento_db_password (stored at /root/.magento_db_password)${NC}"
cat /root/.magento_db_password
echo
echo -e "${RED}Credential: magento_admin_password (stored at /root/.magento_admin_password)${NC}"
cat /root/.magento_admin_password
echo
