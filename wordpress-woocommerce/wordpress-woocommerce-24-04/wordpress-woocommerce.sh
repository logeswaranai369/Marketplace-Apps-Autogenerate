...
mkdir -p {/usr/local/src/wordpress-woocommerce-24-04/etc/apache2/sites-available,/usr/local/src/wordpress-woocommerce-24-04/opt/cloudstack,/usr/local/src/wordpress-woocommerce-24-04/}
